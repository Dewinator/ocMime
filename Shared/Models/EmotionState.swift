...
struct EmotionCommand: Codable {
    let cmd: String           // "emotion", "ping", "avatar", "customAvatar"
    ...
    static func emotion(_ state: EmotionState, intensity: Double = 0.5, context: String? = nil) -> EmotionCommand {
        EmotionCommand(cmd: "emotion", state: state.rawValue, intensity: intensity, context: context, avatar: nil, customAvatar: nil)
    }

    static var ping: EmotionCommand {
        EmotionCommand(cmd: "ping", state: nil, intensity: nil, context: nil, avatar: nil, customAvatar: nil)
    }

    static func avatarUpdate(_ config: AvatarConfig) -> EmotionCommand {
        EmotionCommand(cmd: "avatar", state: nil, intensity: nil, context: nil, avatar: config, customAvatar: nil)
    }

    static func customAvatarUpdate(_ config: CustomAvatarConfig) -> EmotionCommand {
        EmotionCommand(cmd: "customAvatar", state: nil, intensity: nil, context: nil, avatar: nil, customAvatar: config)
    }
